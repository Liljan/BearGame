...
Shader "SH_WarningLamp"
{
    Properties
    {
		[HDR]_WarningColor("WarningColor", Color) = (0.3921569,2,0,1)
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color =  _WarningColor.rgb;
				surfaceDescription.Emission =  _WarningColor.rgb;
...
ASEEND*/
//CHKSM=59513E2FC6BC661D9100C973D46A8C6F079E6F90