...
Shader "SH_VertexColorWolrdSpace"
{
	Properties
	{
		...
		_Tiling("Tiling", Range( 0.1 , 50)) = 7.5
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 appendResult41 = (float2(_Tiling , _Tiling));
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar31 = TriplanarSamplingSF( _Texture0, ase_worldPos, packedInput.ase_normal, 1.0, appendResult41, 1.0, 0 );
				...
				surfaceDescription.Smoothness = ( lerpResult14 * packedInput.ase_color.g );
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Smoothness = ( lerpResult14 * packedInput.interp07.g );
				surfaceDescription.Alpha = 1;
...
/*ASEBEGIN
Version=17700
-1666;44;1666;985;2062.155;101.7899;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;39;-1550.155,622.2101;Inherit;False;Property;_Tiling;Tiling;7;0;Create;True;0;0;False;0;7.5;0;0.1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;41;-1356.155,599.2101;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.VertexColorNode;35;-430.499,533.4273;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-542.6993,336.4729;Inherit;False;Property;_Color;Color;5;0;Create;True;0;0;False;0;0,0,0,0;0.148603,0.1481844,0.1698113,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-158.1929,416.4937;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-143.1929,250.4937;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C5BF6BF88F5B1C4F1CB3A76857535FE08177F8AE